...
extern slurmdbd_msg_type_t str_2_slurmdbd_msg_type(char *msg_type)
{
	...
	} else if (!strcasecmp(msg_type, "Add Federations")) {
	...
	} else if (!strcasecmp(msg_type, "Get Federations")) {
	...
	} else if (!strcasecmp(msg_type, "Got Federations")) {
	...
	} else if (!strcasecmp(msg_type, "Modify Federations")) {
	...
	} else if (!strcasecmp(msg_type, "Remove Federations")) {
